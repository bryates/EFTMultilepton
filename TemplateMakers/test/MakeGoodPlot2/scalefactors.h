...
double HistMaker::partonShowerSF(int bin, vector<string> category, int sys, int nbins) 
{
...
double HistMaker::totalSF(int iSys, vector<string> category, int bin, int nbins)
{
