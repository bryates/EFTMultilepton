void MakeGoodPlot::standard_plots_normalized()
{
    ...
    {    
        ...
        // can1->addPlotNorm(*this,"category_yields",i,"samp");
        // can2->addPlotNorm(*this,"2los_ee__njets",i,"samp");
        // can3->addPlotNorm(*this,"2los_emu__njets",i,"samp");
        // can4->addPlotNorm(*this,"2los_mumu__njets",i,"samp");
        // can5->addPlotNorm(*this,"2los_sfz_ee__njets",i,"samp");
        // can7->addPlotNorm(*this,"2los_sfz_mumu__njets",i,"samp");
        // can8->addPlotNorm(*this,"2lss_p_ee__njets",i,"samp");
        // can9->addPlotNorm(*this,"2lss_p_emu__njets",i,"samp");
        // can10->addPlotNorm(*this,"2lss_p_mumu__njets",i,"samp");
        // can11->addPlotNorm(*this,"2lss_m_ee__njets",i,"samp");
        // can12->addPlotNorm(*this,"2lss_m_emu__njets",i,"samp");
        // can13->addPlotNorm(*this,"2lss_m_mumu__njets",i,"samp");
        // can14->addPlotNorm(*this,"3l_ppp__njets",i,"samp");
        // can15->addPlotNorm(*this,"3l_mmm__njets",i,"samp");
        // can16->addPlotNorm(*this,"3l_mix__njets",i,"samp");
        // can17->addPlotNorm(*this,"3l_mix_sfz__njets",i,"samp");
        // can18->addPlotNorm(*this,"ge4l__njets",i,"samp");
        // can1l_mu__njets->addPlotNorm(*this,"1l_mu__njets",i,"samp");
        // can1l_e__njets->addPlotNorm(*this,"1l_e__njets",i,"samp");

        // can19->addPlotNorm(*this,"2los_ee__nbjets",i,"samp");
        // can20->addPlotNorm(*this,"2los_emu__nbjets",i,"samp");
        // can21->addPlotNorm(*this,"2los_mumu__nbjets",i,"samp");
        // can22->addPlotNorm(*this,"2los_sfz_ee__nbjets",i,"samp");
        // can24->addPlotNorm(*this,"2los_sfz_mumu__nbjets",i,"samp");
        // can25->addPlotNorm(*this,"2lss_p_ee__nbjets",i,"samp");
        // can26->addPlotNorm(*this,"2lss_p_emu__nbjets",i,"samp");
        // can27->addPlotNorm(*this,"2lss_p_mumu__nbjets",i,"samp");
        // can28->addPlotNorm(*this,"2lss_m_ee__nbjets",i,"samp");
        // can29->addPlotNorm(*this,"2lss_m_emu__nbjets",i,"samp");
        // can30->addPlotNorm(*this,"2lss_m_mumu__nbjets",i,"samp");
        // can31->addPlotNorm(*this,"3l_ppp__nbjets",i,"samp");
        // can32->addPlotNorm(*this,"3l_mmm__nbjets",i,"samp");
        // can33->addPlotNorm(*this,"3l_mix__nbjets",i,"samp");
        // can34->addPlotNorm(*this,"3l_mix_sfz__nbjets",i,"samp");
        // can35->addPlotNorm(*this,"ge4l__nbjets",i,"samp");   
        // can1l_mu__nbjets->addPlotNorm(*this,"1l_mu__nbjets",i,"samp");   
        // can1l_e__nbjets->addPlotNorm(*this,"1l_e__nbjets",i,"samp");   

        // can2los_ee__jetpt->addPlotNorm(*this,"2los_ee__jetpt",i,"samp");       
        // can2los_emu__jetpt->addPlotNorm(*this,"2los_emu__jetpt",i,"samp");      
        // can2los_mumu__jetpt->addPlotNorm(*this,"2los_mumu__jetpt",i,"samp");     
        // can2los_sfz_ee__jetpt->addPlotNorm(*this,"2los_sfz_ee__jetpt",i,"samp");   
        // can2los_sfz_mumu__jetpt->addPlotNorm(*this,"2los_sfz_mumu__jetpt",i,"samp"); 
        // can2lss_p_ee__jetpt->addPlotNorm(*this,"2lss_p_ee__jetpt",i,"samp",5);     
        // can2lss_p_emu__jetpt->addPlotNorm(*this,"2lss_p_emu__jetpt",i,"samp",5);    
        // can2lss_p_mumu__jetpt->addPlotNorm(*this,"2lss_p_mumu__jetpt",i,"samp",5);   
        // can2lss_m_ee__jetpt->addPlotNorm(*this,"2lss_m_ee__jetpt",i,"samp",5);     
        // can2lss_m_emu__jetpt->addPlotNorm(*this,"2lss_m_emu__jetpt",i,"samp",5);    
        // can2lss_m_mumu__jetpt->addPlotNorm(*this,"2lss_m_mumu__jetpt",i,"samp",5);   
        // can3l_ppp__jetpt->addPlotNorm(*this,"3l_ppp__jetpt",i,"samp",5);        
        // can3l_mmm__jetpt->addPlotNorm(*this,"3l_mmm__jetpt",i,"samp",5);        
        // can3l_mix__jetpt->addPlotNorm(*this,"3l_mix__jetpt",i,"samp",5);        
        // can3l_mix_sfz__jetpt->addPlotNorm(*this,"3l_mix_sfz__jetpt",i,"samp",5);    
        // cange4l__jetpt->addPlotNorm(*this,"ge4l__jetpt",i,"samp",5);        
        // can1l_mu__jetpt->addPlotNorm(*this,"1l_mu__jetpt",i,"samp");        
        // can1l_e__jetpt->addPlotNorm(*this,"1l_e__jetpt",i,"samp");        

        // can2los_ee__jeteta->addPlotNorm(*this,"2los_ee__jeteta",i,"samp");      
        // can2los_emu__jeteta->addPlotNorm(*this,"2los_emu__jeteta",i,"samp");     
        // can2los_mumu__jeteta->addPlotNorm(*this,"2los_mumu__jeteta",i,"samp");    
        // can2los_sfz_ee__jeteta->addPlotNorm(*this,"2los_sfz_ee__jeteta",i,"samp");  
        // can2los_sfz_mumu__jeteta->addPlotNorm(*this,"2los_sfz_mumu__jeteta",i,"samp");
        // can2lss_p_ee__jeteta->addPlotNorm(*this,"2lss_p_ee__jeteta",i,"samp",5);    
        // can2lss_p_emu__jeteta->addPlotNorm(*this,"2lss_p_emu__jeteta",i,"samp",5);   
        // can2lss_p_mumu__jeteta->addPlotNorm(*this,"2lss_p_mumu__jeteta",i,"samp",5);  
        // can2lss_m_ee__jeteta->addPlotNorm(*this,"2lss_m_ee__jeteta",i,"samp",5);    
        // can2lss_m_emu__jeteta->addPlotNorm(*this,"2lss_m_emu__jeteta",i,"samp",5);   
        // can2lss_m_mumu__jeteta->addPlotNorm(*this,"2lss_m_mumu__jeteta",i,"samp",5);  
        // can3l_ppp__jeteta->addPlotNorm(*this,"3l_ppp__jeteta",i,"samp",5);       
        // can3l_mmm__jeteta->addPlotNorm(*this,"3l_mmm__jeteta",i,"samp",5);       
        // can3l_mix__jeteta->addPlotNorm(*this,"3l_mix__jeteta",i,"samp",5);       
        // can3l_mix_sfz__jeteta->addPlotNorm(*this,"3l_mix_sfz__jeteta",i,"samp",5);   
        // cange4l__jeteta->addPlotNorm(*this,"ge4l__jeteta",i,"samp",5);        
        // can1l_mu__jeteta->addPlotNorm(*this,"1l_mu__jeteta",i,"samp");        
        // can1l_e__jeteta->addPlotNorm(*this,"1l_e__jeteta",i,"samp");        

        // can2los_ee__jetcsv->addPlotNorm(*this,"2los_ee__jetcsv",i,"samp");      
        // can2los_emu__jetcsv->addPlotNorm(*this,"2los_emu__jetcsv",i,"samp");     
        // can2los_mumu__jetcsv->addPlotNorm(*this,"2los_mumu__jetcsv",i,"samp");    
        // can2los_sfz_ee__jetcsv->addPlotNorm(*this,"2los_sfz_ee__jetcsv",i,"samp");  
        // can2los_sfz_mumu__jetcsv->addPlotNorm(*this,"2los_sfz_mumu__jetcsv",i,"samp");
        // can2lss_p_ee__jetcsv->addPlotNorm(*this,"2lss_p_ee__jetcsv",i,"samp",5);    
        // can2lss_p_emu__jetcsv->addPlotNorm(*this,"2lss_p_emu__jetcsv",i,"samp",5);   
        // can2lss_p_mumu__jetcsv->addPlotNorm(*this,"2lss_p_mumu__jetcsv",i,"samp",5);  
        // can2lss_m_ee__jetcsv->addPlotNorm(*this,"2lss_m_ee__jetcsv",i,"samp",5);    
        // can2lss_m_emu__jetcsv->addPlotNorm(*this,"2lss_m_emu__jetcsv",i,"samp",5);   
        // can2lss_m_mumu__jetcsv->addPlotNorm(*this,"2lss_m_mumu__jetcsv",i,"samp",5);  
        // can3l_ppp__jetcsv->addPlotNorm(*this,"3l_ppp__jetcsv",i,"samp",5);       
        // can3l_mmm__jetcsv->addPlotNorm(*this,"3l_mmm__jetcsv",i,"samp",5);       
        // can3l_mix__jetcsv->addPlotNorm(*this,"3l_mix__jetcsv",i,"samp",5);       
        // can3l_mix_sfz__jetcsv->addPlotNorm(*this,"3l_mix_sfz__jetcsv",i,"samp",5);   
        // cange4l__jetcsv->addPlotNorm(*this,"ge4l__jetcsv",i,"samp",5);        
        // can1l_mu__jetcsv->addPlotNorm(*this,"1l_mu__jetcsv",i,"samp");        
        // can1l_e__jetcsv->addPlotNorm(*this,"1l_e__jetcsv",i,"samp");        


        // can2los_ee__leppt->addPlotNorm(*this,"2los_ee__leppt",i,"samp");       
        // can2los_emu__leppt->addPlotNorm(*this,"2los_emu__leppt",i,"samp");      
        // can2los_mumu__leppt->addPlotNorm(*this,"2los_mumu__leppt",i,"samp");     
        // can2los_sfz_ee__leppt->addPlotNorm(*this,"2los_sfz_ee__leppt",i,"samp");   
        // can2los_sfz_mumu__leppt->addPlotNorm(*this,"2los_sfz_mumu__leppt",i,"samp"); 
        // can2lss_p_ee__leppt->addPlotNorm(*this,"2lss_p_ee__leppt",i,"samp",5);     
        // can2lss_p_emu__leppt->addPlotNorm(*this,"2lss_p_emu__leppt",i,"samp",5);    
        // can2lss_p_mumu__leppt->addPlotNorm(*this,"2lss_p_mumu__leppt",i,"samp",5);   
        // can2lss_m_ee__leppt->addPlotNorm(*this,"2lss_m_ee__leppt",i,"samp",5);     
        // can2lss_m_emu__leppt->addPlotNorm(*this,"2lss_m_emu__leppt",i,"samp",5);    
        // can2lss_m_mumu__leppt->addPlotNorm(*this,"2lss_m_mumu__leppt",i,"samp",5);   
        // can3l_ppp__leppt->addPlotNorm(*this,"3l_ppp__leppt",i,"samp",5);        
        // can3l_mmm__leppt->addPlotNorm(*this,"3l_mmm__leppt",i,"samp",5);        
        // can3l_mix__leppt->addPlotNorm(*this,"3l_mix__leppt",i,"samp",5);        
        // can3l_mix_sfz__leppt->addPlotNorm(*this,"3l_mix_sfz__leppt",i,"samp",5);   
        // cange4l__leppt->addPlotNorm(*this,"ge4l__leppt",i,"samp",5);        
        // can1l_mu__leppt->addPlotNorm(*this,"1l_mu__leppt",i,"samp");        
        // can1l_e__leppt->addPlotNorm(*this,"1l_e__leppt",i,"samp");        


        // can2los_ee__lepeta->addPlotNorm(*this,"2los_ee__lepeta",i,"samp");      
        // can2los_emu__lepeta->addPlotNorm(*this,"2los_emu__lepeta",i,"samp");     
        // can2los_mumu__lepeta->addPlotNorm(*this,"2los_mumu__lepeta",i,"samp");
        // can2los_sfz_ee__lepeta->addPlotNorm(*this,"2los_sfz_ee__lepeta",i,"samp");  
        // can2los_sfz_mumu__lepeta->addPlotNorm(*this,"2los_sfz_mumu__lepeta",i,"samp");
        // can2lss_p_ee__lepeta->addPlotNorm(*this,"2lss_p_ee__lepeta",i,"samp",5);
        // can2lss_p_emu__lepeta->addPlotNorm(*this,"2lss_p_emu__lepeta",i,"samp",5);
        // can2lss_p_mumu__lepeta->addPlotNorm(*this,"2lss_p_mumu__lepeta",i,"samp",5);  
        // can2lss_m_ee__lepeta->addPlotNorm(*this,"2lss_m_ee__lepeta",i,"samp",5);    
        // can2lss_m_emu__lepeta->addPlotNorm(*this,"2lss_m_emu__lepeta",i,"samp",5);   
        // can2lss_m_mumu__lepeta->addPlotNorm(*this,"2lss_m_mumu__lepeta",i,"samp",5);  
        // can3l_ppp__lepeta->addPlotNorm(*this,"3l_ppp__lepeta",i,"samp",5);       
        // can3l_mmm__lepeta->addPlotNorm(*this,"3l_mmm__lepeta",i,"samp",5);       
        // can3l_mix__lepeta->addPlotNorm(*this,"3l_mix__lepeta",i,"samp",5);       
        // can3l_mix_sfz__lepeta->addPlotNorm(*this,"3l_mix_sfz__lepeta",i,"samp",5);  
        // cange4l__lepeta->addPlotNorm(*this,"ge4l__lepeta",i,"samp",5);        
        // can1l_mu__lepeta->addPlotNorm(*this,"1l_mu__lepeta",i,"samp");        
        // can1l_e__lepeta->addPlotNorm(*this,"1l_e__lepeta",i,"samp");        



        // can2los_ee__met->addPlotNorm(*this,"2los_ee__met",i,"samp");        
        // can2los_emu__met->addPlotNorm(*this,"2los_emu__met",i,"samp");        
        // can2los_mumu__met->addPlotNorm(*this,"2los_mumu__met",i,"samp");       
        // can2los_sfz_ee__met->addPlotNorm(*this,"2los_sfz_ee__met",i,"samp");     
        // can2los_sfz_mumu__met->addPlotNorm(*this,"2los_sfz_mumu__met",i,"samp");   
        // can2lss_p_ee__met->addPlotNorm(*this,"2lss_p_ee__met",i,"samp",5);       
        // can2lss_p_emu__met->addPlotNorm(*this,"2lss_p_emu__met",i,"samp",5);      
        // can2lss_p_mumu__met->addPlotNorm(*this,"2lss_p_mumu__met",i,"samp",5);     
        // can2lss_m_ee__met->addPlotNorm(*this,"2lss_m_ee__met",i,"samp",5);       
        // can2lss_m_emu__met->addPlotNorm(*this,"2lss_m_emu__met",i,"samp",5);      
        // can2lss_m_mumu__met->addPlotNorm(*this,"2lss_m_mumu__met",i,"samp",5);     
        // can3l_ppp__met->addPlotNorm(*this,"3l_ppp__met",i,"samp",5);        
        // can3l_mmm__met->addPlotNorm(*this,"3l_mmm__met",i,"samp",5);        
        // can3l_mix__met->addPlotNorm(*this,"3l_mix__met",i,"samp",5);        
        // can3l_mix_sfz__met->addPlotNorm(*this,"3l_mix_sfz__met",i,"samp",5);      
        // cange4l__met->addPlotNorm(*this,"ge4l__met",i,"samp",5);        
        // can1l_mu__met->addPlotNorm(*this,"1l_mu__met",i,"samp");        
        // can1l_e__met->addPlotNorm(*this,"1l_e__met",i,"samp");        

        // can2los_ee__metphi->addPlotNorm(*this,"2los_ee__metphi",i,"samp");      
        // can2los_emu__metphi->addPlotNorm(*this,"2los_emu__metphi",i,"samp");     
        // can2los_mumu__metphi->addPlotNorm(*this,"2los_mumu__metphi",i,"samp");    
        // can2los_sfz_ee__metphi->addPlotNorm(*this,"2los_sfz_ee__metphi",i,"samp");  
        // can2los_sfz_mumu__metphi->addPlotNorm(*this,"2los_sfz_mumu__metphi",i,"samp");
        // can2lss_p_ee__metphi->addPlotNorm(*this,"2lss_p_ee__metphi",i,"samp",5);    
        // can2lss_p_emu__metphi->addPlotNorm(*this,"2lss_p_emu__metphi",i,"samp",5);   
        // can2lss_p_mumu__metphi->addPlotNorm(*this,"2lss_p_mumu__metphi",i,"samp",5);  
        // can2lss_m_ee__metphi->addPlotNorm(*this,"2lss_m_ee__metphi",i,"samp",5);    
        // can2lss_m_emu__metphi->addPlotNorm(*this,"2lss_m_emu__metphi",i,"samp",5);   
        // can2lss_m_mumu__metphi->addPlotNorm(*this,"2lss_m_mumu__metphi",i,"samp",5);  
        // can3l_ppp__metphi->addPlotNorm(*this,"3l_ppp__metphi",i,"samp",5);       
        // can3l_mmm__metphi->addPlotNorm(*this,"3l_mmm__metphi",i,"samp",5);       
        // can3l_mix__metphi->addPlotNorm(*this,"3l_mix__metphi",i,"samp",5);       
        // can3l_mix_sfz__metphi->addPlotNorm(*this,"3l_mix_sfz__metphi",i,"samp",5);   
        // cange4l__metphi->addPlotNorm(*this,"ge4l__metphi",i,"samp",5);        
        // can1l_mu__metphi->addPlotNorm(*this,"1l_mu__metphi",i,"samp");
        // can1l_e__metphi->addPlotNorm(*this,"1l_e__metphi",i,"samp");

        can2los_ee__numPVs->addPlotNorm(*this,"2los_ee__numPVs",i,"samp");      
        can2los_emu__numPVs->addPlotNorm(*this,"2los_emu__numPVs",i,"samp");     
        can2los_mumu__numPVs->addPlotNorm(*this,"2los_mumu__numPVs",i,"samp");    
        can2los_sfz_ee__numPVs->addPlotNorm(*this,"2los_sfz_ee__numPVs",i,"samp");  
        can2los_sfz_mumu__numPVs->addPlotNorm(*this,"2los_sfz_mumu__numPVs",i,"samp");
        can2lss_p_ee__numPVs->addPlotNorm(*this,"2lss_p_ee__numPVs",i,"samp",5);    
        can2lss_p_emu__numPVs->addPlotNorm(*this,"2lss_p_emu__numPVs",i,"samp",5);   
        can2lss_p_mumu__numPVs->addPlotNorm(*this,"2lss_p_mumu__numPVs",i,"samp",5);  
        can2lss_m_ee__numPVs->addPlotNorm(*this,"2lss_m_ee__numPVs",i,"samp",5);    
        can2lss_m_emu__numPVs->addPlotNorm(*this,"2lss_m_emu__numPVs",i,"samp",5);   
        can2lss_m_mumu__numPVs->addPlotNorm(*this,"2lss_m_mumu__numPVs",i,"samp",5);  
        can3l_ppp__numPVs->addPlotNorm(*this,"3l_ppp__numPVs",i,"samp",5);       
        can3l_mmm__numPVs->addPlotNorm(*this,"3l_mmm__numPVs",i,"samp",5);       
        can3l_mix__numPVs->addPlotNorm(*this,"3l_mix__numPVs",i,"samp",5);       
        can3l_mix_sfz__numPVs->addPlotNorm(*this,"3l_mix_sfz__numPVs",i,"samp",5);   
        ...
        // can2los_mumu__lep1pt->addPlotNorm(*this,"2los_mumu__lep1pt",i,"samp");    
        // can2los_sfz_ee__lep1pt->addPlotNorm(*this,"2los_sfz_ee__lep1pt",i,"samp");  
        // can2los_sfz_mumu__lep1pt->addPlotNorm(*this,"2los_sfz_mumu__lep1pt",i,"samp");
        // can2lss_p_ee__lep1pt->addPlotNorm(*this,"2lss_p_ee__lep1pt",i,"samp",5);    
        // can2lss_p_emu__lep1pt->addPlotNorm(*this,"2lss_p_emu__lep1pt",i,"samp",5);   
        // can2lss_p_mumu__lep1pt->addPlotNorm(*this,"2lss_p_mumu__lep1pt",i,"samp",5);  
        // can2lss_m_ee__lep1pt->addPlotNorm(*this,"2lss_m_ee__lep1pt",i,"samp",5);    
        // can2lss_m_emu__lep1pt->addPlotNorm(*this,"2lss_m_emu__lep1pt",i,"samp",5);   
        // can2lss_m_mumu__lep1pt->addPlotNorm(*this,"2lss_m_mumu__lep1pt",i,"samp",5);  
        // can3l_ppp__lep1pt->addPlotNorm(*this,"3l_ppp__lep1pt",i,"samp",5);       
        // can3l_mmm__lep1pt->addPlotNorm(*this,"3l_mmm__lep1pt",i,"samp",5);       
        // can3l_mix__lep1pt->addPlotNorm(*this,"3l_mix__lep1pt",i,"samp",5);       
        // can3l_mix_sfz__lep1pt->addPlotNorm(*this,"3l_mix_sfz__lep1pt",i,"samp",5);   
        // cange4l__lep1pt->addPlotNorm(*this,"ge4l__lep1pt",i,"samp",5);
        // can1l_mu__lep1pt->addPlotNorm(*this,"1l_mu__lep1pt",i,"samp");
        // can1l_e__lep1pt->addPlotNorm(*this,"1l_e__lep1pt",i,"samp");            
        
        // can2los_ee__lep2pt->addPlotNorm(*this,"2los_ee__lep2pt",i,"samp");      
        // can2los_emu__lep2pt->addPlotNorm(*this,"2los_emu__lep2pt",i,"samp");     
        // can2los_mumu__lep2pt->addPlotNorm(*this,"2los_mumu__lep2pt",i,"samp");    
        // can2los_sfz_ee__lep2pt->addPlotNorm(*this,"2los_sfz_ee__lep2pt",i,"samp");  
        // can2los_sfz_mumu__lep2pt->addPlotNorm(*this,"2los_sfz_mumu__lep2pt",i,"samp");
        // can2lss_p_ee__lep2pt->addPlotNorm(*this,"2lss_p_ee__lep2pt",i,"samp",5);    
        // can2lss_p_emu__lep2pt->addPlotNorm(*this,"2lss_p_emu__lep2pt",i,"samp",5);   
        // can2lss_p_mumu__lep2pt->addPlotNorm(*this,"2lss_p_mumu__lep2pt",i,"samp",5);  
        // can2lss_m_ee__lep2pt->addPlotNorm(*this,"2lss_m_ee__lep2pt",i,"samp",5);    
        // can2lss_m_emu__lep2pt->addPlotNorm(*this,"2lss_m_emu__lep2pt",i,"samp",5);   
        // can2lss_m_mumu__lep2pt->addPlotNorm(*this,"2lss_m_mumu__lep2pt",i,"samp",5);  
        // can3l_ppp__lep2pt->addPlotNorm(*this,"3l_ppp__lep2pt",i,"samp",5);       
        // can3l_mmm__lep2pt->addPlotNorm(*this,"3l_mmm__lep2pt",i,"samp",5);       
        // can3l_mix__lep2pt->addPlotNorm(*this,"3l_mix__lep2pt",i,"samp",5);       
        // can3l_mix_sfz__lep2pt->addPlotNorm(*this,"3l_mix_sfz__lep2pt",i,"samp",5);   
        // cange4l__lep2pt->addPlotNorm(*this,"ge4l__lep2pt",i,"samp",5);


        // can2los_ee__llmass->addPlotNorm(*this,"2los_ee__llmass",i,"samp");      
        // can2los_emu__llmass->addPlotNorm(*this,"2los_emu__llmass",i,"samp");     
        // can2los_mumu__llmass->addPlotNorm(*this,"2los_mumu__llmass",i,"samp");    
        // can2los_sfz_ee__llmass->addPlotNorm(*this,"2los_sfz_ee__llmass",i,"samp");  
        // can2los_sfz_mumu__llmass->addPlotNorm(*this,"2los_sfz_mumu__llmass",i,"samp");
        // can2lss_p_ee__llmass->addPlotNorm(*this,"2lss_p_ee__llmass",i,"samp",5);    
        // can2lss_p_emu__llmass->addPlotNorm(*this,"2lss_p_emu__llmass",i,"samp",5);   
        // can2lss_p_mumu__llmass->addPlotNorm(*this,"2lss_p_mumu__llmass",i,"samp",5);  
        // can2lss_m_ee__llmass->addPlotNorm(*this,"2lss_m_ee__llmass",i,"samp",5);    
        // can2lss_m_emu__llmass->addPlotNorm(*this,"2lss_m_emu__llmass",i,"samp",5);   
        // can2lss_m_mumu__llmass->addPlotNorm(*this,"2lss_m_mumu__llmass",i,"samp",5);  


        // can2los_ee__MHT->addPlotNorm(*this,"2los_ee__MHT",i,"samp");      
        // can2los_emu__MHT->addPlotNorm(*this,"2los_emu__MHT",i,"samp");     
        // can2los_mumu__MHT->addPlotNorm(*this,"2los_mumu__MHT",i,"samp");    
        // can2los_sfz_ee__MHT->addPlotNorm(*this,"2los_sfz_ee__MHT",i,"samp");  
        // can2los_sfz_mumu__MHT->addPlotNorm(*this,"2los_sfz_mumu__MHT",i,"samp");
        // can2lss_p_ee__MHT->addPlotNorm(*this,"2lss_p_ee__MHT",i,"samp",5);    
        // can2lss_p_emu__MHT->addPlotNorm(*this,"2lss_p_emu__MHT",i,"samp",5);   
        // can2lss_p_mumu__MHT->addPlotNorm(*this,"2lss_p_mumu__MHT",i,"samp",5);  
        // can2lss_m_ee__MHT->addPlotNorm(*this,"2lss_m_ee__MHT",i,"samp",5);    
        // can2lss_m_emu__MHT->addPlotNorm(*this,"2lss_m_emu__MHT",i,"samp",5);   
        // can2lss_m_mumu__MHT->addPlotNorm(*this,"2lss_m_mumu__MHT",i,"samp",5);  
        // can3l_ppp__MHT->addPlotNorm(*this,"3l_ppp__MHT",i,"samp",5);       
        // can3l_mmm__MHT->addPlotNorm(*this,"3l_mmm__MHT",i,"samp",5);       
        // can3l_mix__MHT->addPlotNorm(*this,"3l_mix__MHT",i,"samp",5);       
        // can3l_mix_sfz__MHT->addPlotNorm(*this,"3l_mix_sfz__MHT",i,"samp",5);   
        // cange4l__MHT->addPlotNorm(*this,"ge4l__MHT",i,"samp",5);
        // can1l_mu__MHT->addPlotNorm(*this,"1l_mu__MHT",i,"samp");
        // can1l_e__MHT->addPlotNorm(*this,"1l_e__MHT",i,"samp");            

        // can2los_ee__lepMVA->addPlotNorm(*this,"2los_ee__lepMVA",i,"samp");      
        // can2los_emu__lepMVA->addPlotNorm(*this,"2los_emu__lepMVA",i,"samp");     
        // can2los_mumu__lepMVA->addPlotNorm(*this,"2los_mumu__lepMVA",i,"samp");    
        // can2los_sfz_ee__lepMVA->addPlotNorm(*this,"2los_sfz_ee__lepMVA",i,"samp");  
        // can2los_sfz_mumu__lepMVA->addPlotNorm(*this,"2los_sfz_mumu__lepMVA",i,"samp");
        // // can2lss_p_ee__lepMVA->addPlotNorm(*this,"2lss_p_ee__lepMVA",i,"samp",5);    
        // // can2lss_p_emu__lepMVA->addPlotNorm(*this,"2lss_p_emu__lepMVA",i,"samp",5);   
        // // can2lss_p_mumu__lepMVA->addPlotNorm(*this,"2lss_p_mumu__lepMVA",i,"samp",5);  
        // // can2lss_m_ee__lepMVA->addPlotNorm(*this,"2lss_m_ee__lepMVA",i,"samp",5);    
        // // can2lss_m_emu__lepMVA->addPlotNorm(*this,"2lss_m_emu__lepMVA",i,"samp",5);   
        // // can2lss_m_mumu__lepMVA->addPlotNorm(*this,"2lss_m_mumu__lepMVA",i,"samp",5);  
        // // can3l_ppp__lepMVA->addPlotNorm(*this,"3l_ppp__lepMVA",i,"samp",5);       
        // // can3l_mmm__lepMVA->addPlotNorm(*this,"3l_mmm__lepMVA",i,"samp",5);       
        // // can3l_mix__lepMVA->addPlotNorm(*this,"3l_mix__lepMVA",i,"samp",5);       
        // // can3l_mix_sfz__lepMVA->addPlotNorm(*this,"3l_mix_sfz__lepMVA",i,"samp",5);   
        // // cange4l__lepMVA->addPlotNorm(*this,"ge4l__lepMVA",i,"samp",5);
        // can1l_mu__lepMVA->addPlotNorm(*this,"1l_mu__lepMVA",i,"samp");
        // can1l_e__lepMVA->addPlotNorm(*this,"1l_e__lepMVA",i,"samp");
