#ifndef _TightChargeAndLepMVAScaleFactors8TeV2014_h
#define _TightChargeAndLepMVAScaleFactors8TeV2014_h

class TightChargeAndLepMVAScaleFactors8TeV2014: public KinematicVariable<double> {

public:
  TightChargeAndLepMVAScaleFactors8TeV2014(int _numLeps, BNleptonCollection **_leptonsPtr, string _label);
  ~TightChargeAndLepMVAScaleFactors8TeV2014();
  void evaluate();
...
TightChargeAndLepMVAScaleFactors8TeV2014::TightChargeAndLepMVAScaleFactors8TeV2014 (int _numLeps, BNleptonCollection **_leptonsPtr, string _label = ""):
  electronFile((string(getenv("CMSSW_BASE"))+"/src/EFTMultilepton/TemplateMakers/data/NOVA/lepMVA_weights/MVAandTightChargeSF_ele.root").c_str()),
  muonFile((string(getenv("CMSSW_BASE"))+"/src/EFTMultilepton/TemplateMakers/data/NOVA/lepMVA_weights/MVAandTightChargeSF_mu.root").c_str()),
  numLeps(_numLeps),
...
void TightChargeAndLepMVAScaleFactors8TeV2014::evaluate() {
...
double TightChargeAndLepMVAScaleFactors8TeV2014::fetch(BNlepton* lepton, TH2D* histo) {
...
TightChargeAndLepMVAScaleFactors8TeV2014::~TightChargeAndLepMVAScaleFactors8TeV2014() {
